...
const technologies = [
  ...
  },
  {
    ...
    icon: SiTailwindcss,
    description:
      "Utility-first CSS framework untuk styling cepat dan responsif.",
  ...
  },
  {
    ...
    icon: SiGooglecloud,
    description:
      "Model AI generatif Google untuk analisis dan konteks pembelajaran.",
...
export default function Technology() {
  ...
  return (
    <section className="relative min-h-screen py-20 overflow-hidden flex items-center justify-center">
      ...
      {/* Content Container */}
      <div className="relative max-w-7xl mx-auto px-6 w-full mt-20">
        {/* Section Header */}
        <motion.div
